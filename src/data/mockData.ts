import { CloudProvider, Project, Resource, Organization, OrganizationTenant } from '@/types';
...
export const mockOrganizations: Organization[] = [
  {
    ...
    totalCost: 5400,
    members: [
      { id: 1, name: '김철수', email: 'kim.cs@example.com', role: 'OWNER' },
      { id: 2, name: '이영희', email: 'lee.yh@example.com', role: 'ADMIN' },
      { id: 3, name: '박민수', email: 'park.ms@example.com', role: 'MEMBER' },
      { id: 4, name: '정수진', email: 'jung.sj@example.com', role: 'MEMBER' },
      { id: 5, name: '최동욱', email: 'choi.dw@example.com', role: 'VIEWER' },
    ],
  ...
  },
  {
    ...
    totalCost: 1200,
    members: [
      { id: 6, name: '한지민', email: 'han.jm@example.com', role: 'OWNER' },
      { id: 7, name: '송중기', email: 'song.jk@example.com', role: 'ADMIN' },
      { id: 8, name: '윤아름', email: 'yoon.ar@example.com', role: 'MEMBER' },
    ],
  ...
  },
  {
    ...
    totalCost: 800,
    members: [
      { id: 9, name: '강호동', email: 'kang.hd@example.com', role: 'OWNER' },
      { id: 10, name: '유재석', email: 'yoo.js@example.com', role: 'MEMBER' },
    ],
  ...
  },
  {
    ...
    totalCost: 0,
    members: [
      { id: 11, name: '박명수', email: 'park.ms2@example.com', role: 'OWNER' },
    ],
...
/**
 * Mock Organization Tenants Data
 */
export const mockOrganizationTenants: OrganizationTenant[] = [
  {
    id: 1,
    ...
    updatedBy: 'admin',
    isDeleted: false,
    tenantKey: 'ecommerce-platform-001',
    tenantName: 'E-Commerce 플랫폼 테넌트',
    description: 'E-Commerce 플랫폼의 전용 클라우드 환경',
    organization: {
      id: 1,
      name: 'E-Commerce Platform Organization',
      createdAt: '2024-01-01T00:00:00Z',
    ...
    contactEmail: 'ecommerce-team@example.com',
  ...
  },
  {
    ...
    updatedBy: 'admin',
    isDeleted: false,
    tenantKey: 'mobile-dev-002',
    tenantName: '모바일 개발팀 테넌트',
    description: '모바일 앱 개발팀 전용 환경',
    organization: {
      id: 2,
      name: 'Mobile App Development',
      createdAt: '2024-01-10T00:00:00Z',
    ...
    maxResources: 25,
    storageQuotaGb: 500,
    bandwidthQuotaGb: 250,
    contactEmail: 'mobile-team@example.com',
    contactPhone: '010-2345-6789',
    billingAddress: '서울시 서초구 서초대로 456, 5층',
    settings:
      '{"theme":"light","language":"ko","timezone":"Asia/Seoul","notifications":{"email":true,"sms":true}}',
    subscriptionStartDate: '2024-01-10T00:00:00',
    subscriptionEndDate: '2024-06-30T23:59:59',
    isTrial: false,
    trialEndDate: null,
  },
  {
    ...
    isDeleted: false,
    tenantKey: 'data-analytics-003',
    tenantName: '데이터 분석팀 테넌트',
    description: '데이터 분석 및 ML 팀 전용 환경',
    organization: {
      id: 3,
      name: 'Data Analytics Team',
      createdAt: '2024-01-15T00:00:00Z',
    ...
    billingAddress: '서울시 강남구 역삼로 789, 15층',
    settings:
      '{"theme":"dark","language":"en","timezone":"Asia/Seoul","notifications":{"email":true,"sms":false}}',
  ...
  },
  {
    ...
    updatedBy: 'admin',
    isDeleted: false,
    tenantKey: 'legacy-systems-004',
    tenantName: '레거시 시스템 테넌트',
    description: '레거시 시스템 마이그레이션 환경',
    organization: {
      id: 4,
      name: 'Legacy Systems',
      createdAt: '2023-12-01T00:00:00Z',
    ...
    storageQuotaGb: 100,
    bandwidthQuotaGb: 50,
    contactEmail: 'legacy-team@example.com',
    contactPhone: '010-4567-8901',
    billingAddress: '서울시 용산구 한강대로 111, 3층',
    settings:
      '{"theme":"light","language":"ko","timezone":"Asia/Seoul","notifications":{"email":false,"sms":false}}',
    subscriptionStartDate: '2023-12-01T00:00:00',
    subscriptionEndDate: '2024-03-31T23:59:59',
    isTrial: false,
    trialEndDate: null,
  },
];
